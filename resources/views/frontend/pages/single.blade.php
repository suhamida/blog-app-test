                ...
                <div class="col-md-6">
                    <div class="post-entry text-center">
                        ...
                        <div class="post-meta align-items-center text-center">
                            <figure class="author-figure mb-0 me-3 d-inline-block"><img src="{{ asset('/') }}front/images/person_1.jpg" alt="Image" class="img-fluid"></figure>                            <span class="d-inline-block mt-1">By Carl Atkinson</span>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3">
                    <div class="blog-entry">
                        <a href="{{route('single',['id'=> $blog->id])}}" class="img-link">
                            <img src="{{asset('/')}}front/images/img_1_horizontal.jpg" alt="Image" class="img-fluid">
                        </a>
                        <span class="date">Apr. 14th, 2022</span>
                        <h2><a href="{{route('single',['id'=> $blog->id])}}">Thought you loved Python? Wait until you meet Rust</a></h2>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="blog-entry">
                        ...
                        <span class="date">Apr. 14th, 2022</span>
                        <h2><a href="{{route('single',['id'=> $blog->id])}}">Startup vs corporate: What job suits you best?</a></h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                        <p><a href="#" class="read-more">Continue Reading</a></p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="blog-entry">
                        ...
                        <span class="date">Apr. 14th, 2022</span>
                        <h2><a href="{{route('single',['id'=> $blog->id])}}">UK sees highest inflation in 30 years</a></h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                        <p><a href="#" class="read-more">Continue Reading</a></p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="blog-entry">
                        ...
                        <span class="date">Apr. 14th, 2022</span>
                        <h2><a href="{{route('single',['id'=> $blog->id])}}">Don’t assume your user data in the cloud is safe</a></h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                        <p><a href="#" class="read-more">Continue Reading</a></p>
                    </div>
                </div>
